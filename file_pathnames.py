...
ROOT_PATH = Path('C:\\Users\\AAAAAA\\Snow_Optics\\')              # Project root path

CODE_PATH = ROOT_PATH / 'Code/CRREL-GOSRT'                        # Path where code resides

MCT_IMAGE_PATH = ROOT_PATH / 'MicroCT_Data/Pit10'                 # Path to MicroCT data for specific sample of interest
MATERIAL_PATH = ROOT_PATH / 'Code/CRREL-GOSRT/Materials/'         # Path to material property CSV files
VTK_DATA_OUTPATH = ROOT_PATH / 'MicroCT_Data/VTK/Pit10'           # Output path for mesh VTK data
OPT_PROP_OUTPATH = ROOT_PATH / 'MicroCT_Data/VTK/Pit10'           # Output path for optical properties file
