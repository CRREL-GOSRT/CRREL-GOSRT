...
Slab.namelistDict['MasterPath']='/Users/rdcrltwl/Desktop/ESC_2021/OpticalProps/Test/'
SnowTypes=['FineGrain.txt','Facets.txt']
Slab.namelistDict['LayerTops']=[depth,0]
Slab.namelistDict['DiffuseFraction']=1.
...
for sdx, s in enumerate(SnowTypes):
    ...
    Slab.WriteSpectralToFile('/Users/rdcrltwl/Desktop/ESC_2021/OpticalProps/Test/%s_%scm.txt'%(s,depth),
